...
@NgModule({
  declarations: [AppComponent, HomepageComponent, AppHeaderComponent, ContactsPageComponent, ContactsFilterComponent, ContactsListComponent, ContactsPreviewComponent, ContactDetailsPageComponent],
